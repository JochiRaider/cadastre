...
Runtime behavior remains owned by `010` and `020`; this ADR is rationale only and must not define field shapes, algorithms, defaults, errors, or acceptance criteria.
