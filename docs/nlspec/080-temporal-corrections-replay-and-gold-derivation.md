...
| unauthorized CDC tombstone | no mutation and preserve raw delete evidence | `CDC_TOMBSTONE_RETRACTION_UNAUTHORIZED` | no retraction, cleanup, graph expiry, watermark |
...
| `CDC_TOMBSTONE_RETRACTION_UNAUTHORIZED` | CDC tombstone/delete evidence attempts retraction without exact `060` authorization and correction gates. |
