...
| `ADR-0001` | docs/adr/ADR-0001-lakehouse-fed-boundary.md | rationale | `draft` | 010,020 | No | Rationale only. |
| `ADR-0002` | docs/adr/ADR-0002-graph-as-derived-projection.md | rationale | `draft` | 090 | No | Rationale only. |
| `ADR-0003` | docs/adr/ADR-0003-ocsf-as-silver-profile.md | rationale | `draft` | 050 | No | Rationale only. |
| `ADR-0004` | docs/adr/ADR-0004-package-set-activation.md | rationale | `draft` | 100 | No | Rationale only. |
...
| --- | --- | --- | --- | --- | --- |
| Documentation governance | `000` | `MANIFEST.md` and registered documentation artifacts | governance | 120 | open |
| Root domain vocabulary | `domain` | all owner specs | vocabulary | 120 | open until domain TODOs close |
...
| `000-CLEANUP-AC-002` | `SpecStatus` is total for `draft`, `candidate`, `authoritative`, `superseded`, `archived`, `inactive_deferred`, and `active_standard`. |
